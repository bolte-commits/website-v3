!(function t(e, i, n) {
...
})(
    {
        ...
        2: [
            function (t, e, i) {
                ...
                (e.exports = function (t, e, i) {
                    return e && s(t.prototype, e), i && s(t, i), Object.defineProperty(t, "prototype", { writable: !1 }), t;
                }),
                    (e.exports.__esModule = !0),
                    (e.exports.default = e.exports);
            },
        ...
        17: [
            function (t, e, i) {
                "use strict";
                e.exports = Object.freeze({ ELEMENT: 1, TEXT: 3, COMMENT: 8, DOCUMENT: 9, DOCUMENT_TYPE: 10, DOCUMENT_FRAGMENT: 11 });
            },
            {},
        ],
        18: [
        ...
        22: [
            function (t, e, i) {
                "use strict";
                e.exports = { EventEmitterMicro: t(23) };
            },
            { 23: 23 },
        ],
        23: [
        ...
        25: [
            function (t, e, i) {
                ...
                var n = t(21),
                    ...
                    _ = function (t, e) {
                        ...
                        (e = Object.assign({}, m, e)),
                            ...
                            this.tray && !this.tray.id && this.tray.setAttribute("id", this._selectors.menuStateID + "-tray"),
                            (this.curtain = document.getElementById(this._selectors.curtainID)),
                            ...
                            // Always create sticky functionality
                            (this._sticky = new u(this.el, e)),
                ...
                (p._getStickyEnabled = function () {
                    // Always enable sticky functionality
                    return true;
                }),
                    (p._initializeMenu = function () {
                        var t,
                            ...
                            i,
                            n,
                            s = document.getElementById(this._selectors.menuStateID),
                        ...
                        s && r && a) &&
                            ((this.menu = new h(s, r, a, this.tray, o, this._selectors.menuCtaClickClassName)),
                            (this._onMenuOpen = this._onMenuOpen.bind(this)),
                            (this._onMenuClose = this._onMenuClose.bind(this)),
                            this.menu.on("open", this._onMenuOpen),
                            this.menu.on("close", this._onMenuClose),
                            (this._onViewportChange = this._onViewportChange.bind(this)),
                            this._viewports.on("change:viewport", this._onViewportChange),
                            ...
                            null === (t = this.tray) || void 0 === t || t.addEventListener("click", this._onTrayClick),
                            (this._closeMenu = this._closeMenu.bind(this)),
                            window.addEventListener(u, this._closeMenu),
                            window.addEventListener("orientationchange", this._closeMenu),
                            (this.clickAway = new l(this._selectors.clickAwaySelector)),
                            this.clickAway.on("click", this._closeMenu),
                            (this._onTextZoom = this._onTextZoom.bind(this)),
                            window.addEventListener("resize:text-zoom", this._onTextZoom),
                            c.detect(),
                            this._transitionsAvailable &&
                                ((this._numAnimatingMenuElements = 0),
                                (this._onTrayTransitionStart = this._onTrayTransitionStart.bind(this)),
                                (this._onTrayTransitionCancel = this._onTrayTransitionCancel.bind(this)),
                                (this._onTrayTransitionEnd = this._onTrayTransitionEnd.bind(this)),
                                (this._onCurtainTransitionStart = this._onCurtainTransitionStart.bind(this)),
                                (this._onCurtainTransitionEnd = this._onCurtainTransitionEnd.bind(this)),
                                null === (e = this.tray) || void 0 === e || e.addEventListener("transitionstart", this._onTrayTransitionStart),
                                null === (i = this.tray) || void 0 === i || i.addEventListener("transitioncancel", this._onTrayTransitionCancel),
                                null === (n = this.tray) || void 0 === n || n.addEventListener("transitionend", this._onTrayTransitionEnd),
                                this.curtain.addEventListener("transitionstart", this._onCurtainTransitionStart),
                                this.curtain.addEventListener("transitionend", this._onCurtainTransitionEnd)));
                    ...
                    (p._onScroll = function (t) {
                        ...
                        this.tray &&
                            this.menu.isOpen() &&
                            (null === this._menuCollapseOnScroll && (this._menuCollapseOnScroll = this.tray.offsetHeight >= this.tray.scrollHeight),
                            this._menuCollapseOnScroll ? this._closeMenu() : ((e = t.target), (n(e, d) && s(e, this._selectors.traySelector, !0)) || (t.preventDefault(), (this._menuCollapseOnScroll = !0))));
                    }),
                    ...
                    (p._setCssVars = function () {
                        var t = this;
                        this.tray && this.tray.scrollHeight && this.tray.style.setProperty("--r-localnav-menu-tray-natural-height", "".concat(this.tray.scrollHeight, "px")),
                            setTimeout(function () {
                    ...
                    (p.destroy = function () {
                        var t,
                            ...
                            s,
                            r,
                            a = "onpopstate" in window ? "popstate" : "beforeunload";
                        for (var o in (window.removeEventListener("scroll", this._onScroll),
                        window.removeEventListener("touchmove", this._onScroll),
                        window.removeEventListener("keydown", this._onKeyDown),
                        window.removeEventListener(a, this._closeMenu),
                        window.removeEventListener("orientationchange", this._closeMenu),
                        window.removeEventListener("resize", this._setCssVarsDebounced),
                        null === (t = this.tray) || void 0 === t || t.removeEventListener("click", this._onTrayClick),
                        null === (e = this.tray) || void 0 === e || e.removeEventListener("transitionstart", this._onTrayTransitionStart),
                        null === (i = this.tray) || void 0 === i || i.removeEventListener("transitioncancel", this._onTrayTransitionCancel),
                        null === (n = this.tray) || void 0 === n || n.removeEventListener("transitionend", this._onTrayTransitionEnd),
                        this.curtain.removeEventListener("transitionstart", this._onCurtainTransitionStart),
                        this.curtain.removeEventListener("transitionend", this._onCurtainTransitionEnd),
                        null === (s = this.menu) || void 0 === s || s.destroy(),
                        this.circTab.destroy(),
                        null === (r = this.clickAway) || void 0 === r || r.destroy(),
                        this._viewports.destroy(),
                        window.removeEventListener("resize:text-zoom", this._onTextZoom),
                        c.remove(),
                        this.stickyEnabled && this._sticky.destroy(),
                        this))
                            Object.prototype.hasOwnProperty.call(this, o) && (this[o] = null);
                    }),
                    (e.exports = _);
            },
            { 17: 17, 21: 21, 26: 26, 28: 28, 29: 29, 50: 50, 53: 53, 62: 62, 7: 7, 8: 8 },
        ],
        26: [
            function (t, e, i) {
                "use strict";
                ...
                function r(t, e, i, r, a, o) {
                    n.call(this),
                        ...
                        this.el.setAttribute("aria-controls", this.controlled.id),
                        this.el.setAttribute("aria-expanded", this.el.checked),
                        this.anchorOpen.setAttribute("aria-controls", this.controlled.id),
                        this.anchorOpen.setAttribute("aria-expanded", "false"),
                        this.anchorClose.setAttribute("aria-controls", this.controlled.id),
                        this.anchorClose.setAttribute("aria-expanded", "true"),
                        this.el.addEventListener("change", this.update.bind(this)),
                        (this._anchorOpenClick = this._anchorOpenClick.bind(this)),
                        (this._anchorCloseClick = this._anchorCloseClick.bind(this)),
                        (this._anchorOpenKeyDown = this._anchorOpenKeyDown.bind(this)),
                        (this._anchorCloseKeyDown = this._anchorCloseKeyDown.bind(this)),
                        this.anchorOpen.addEventListener("click", this._anchorOpenClick),
                        this.anchorClose.addEventListener("click", this._anchorCloseClick),
                        this.anchorOpen.addEventListener("keydown", this._anchorOpenKeyDown),
                        this.anchorClose.addEventListener("keydown", this._anchorCloseKeyDown),
                        (this._removeClickClass = this._removeClickClass.bind(this)),
                        (this.chevron = new s(this.chevronEl)),
                ...
                (r.prototype.constructor = r),
                    (o.update = function (t) {
                        ...
                        i !== this._lastOpen &&
                            ...
                            this.el.setAttribute("aria-expanded", i ? "true" : "false"),
                            i ? (this.chevron.expand(), (e = this.anchorClose)) : (this.chevron.collapse(), (e = this.anchorOpen)),
                            t && (e.focus(), r && (e.classList.add(this.clickClass), document.body.removeEventListener("keydown", this._removeClickClass), document.body.addEventListener("keydown", this._removeClickClass, { once: !0 }))),
                            (this._lastOpen = i));
                    }),
                    (o.isOpen = function () {
                    ...
                    (o.destroy = function () {
                        this.el.removeAttribute("aria-controls"),
                            ...
                            this.anchorOpen.removeAttribute("aria-controls"),
                            this.anchorOpen.removeAttribute("aria-expanded"),
                            this.anchorClose.removeAttribute("aria-controls"),
                            this.anchorClose.removeAttribute("aria-expanded"),
                            this.anchorOpen.removeEventListener("click", this._anchorOpenClick),
                            this.anchorClose.removeEventListener("click", this._anchorCloseClick),
                            this.anchorOpen.removeEventListener("keydown", this._anchorOpenKeyDown),
                            this.anchorClose.removeEventListener("keydown", this._anchorCloseKeyDown),
                            document.body.removeEventListener("keydown", this._removeClickClass),
        ...
        27: [
            function (t, e, i) {
                ...
                var n = "15.265 .835 8 8.167 .735 .835",
                    ...
                    a = '\n<svg viewBox="0 0 16 9" data-chevron-icon xmlns="http://www.w3.org/2000/svg" >\n\t<polyline shape-rendering="geometricPrecision" data-chevron-icon-shape stroke="currentColor" stroke-linecap="round" vector-effect="non-scaling-stroke" stroke-linejoin="round" fill="none" fill-rule="evenodd" points="'
                ...
                function o(t) {
                    (this._originialContents = t.innerHTML),
                        (t.innerHTML = o.TEMPLATE),
                        (this.el = t),
                        (this._shape = t.querySelector(o.SELECTORS.shape)),
                        (this._expandAnimation = t.querySelector(o.SELECTORS.expandAnimation)),
                ...
                (o.prototype.constructor = o),
                    (o.TEMPLATE = a),
                    (o.SELECTORS = { selector: "[data-chevron-icon]", shape: "[data-chevron-icon-shape]", expandAnimation: '[data-chevron-animate="expand"]', collapseAnimation: '[data-chevron-animate="collapse"]' }),
                    (c.destroy = function () {
        ...
        29: [
            function (t, e, i) {
                ...
                var n = t(22).EventEmitterMicro,
                    ...
                    c = function (t, e) {
                        n.call(this),
                            (this.el = t),
                            (this.stuck = !1),
                            (this._selectors = { placeholderID: e.placeholderID || e.className + "-sticky-placeholder", stuckClassName: e.stuckClassName || e.className + "-sticking" }),
                ...
                (c.prototype.constructor = c),
                    ...
                    (u._initIO = function () {
                        // Always make navbar visible - no complex logic needed
                        this._updatePosition(true);
                    }),
                    (u._updatePosition = function (t) {
                        // Always keep navbar visible - simple and direct
                        this.el.classList.add(this._selectors.stuckClassName);
        ...
        40: [
            function (t, e, i) {
                ...
                function r(t) {
                    ...
                    var e = null,
                        i = null;
                    "undefined" != typeof window ? ((e = window.requestAnimationFrame), (i = window.cancelAnimationFrame)) : (e = i = function () {}),
                    ...
                    (n.subscribeImmediate = function (t, e) {
                        return (
                            ...
                            this._subscribers[t.id] ||
                                (e ? this._subscribersOrder.splice(this._currentSubscriberIndex + 1, 0, t.id) : this._subscribersOrder.unshift(t.id), (this._subscribers[t.id] = t), this._subscriberArrayLength++, this._subscriberCount++),
                            this._totalSubscribeCount
                        );
                    }),
                    ...
                    (n._cancel = function () {
                        ...
                        return (
                            this._animationFrameActive &&
                                (this._animationFrame && (this._cancelAnimationFrame.call(window, this._animationFrame), (this._animationFrame = null)), (this._animationFrameActive = !1), (this._willRun = !1), (t = !0)),
                ...
                (r.requestAnimationFrame = function (t, e) {
                    return (
                        !0 === e && this.rafEmitter.executor.phaseIndex > 0 && this.rafEmitter.executor.phaseIndex <= this.phaseIndex
                            ? this._phaseActive
                                ? ((this._currentFrameID = this.rafEmitter.executor.subscribeImmediate(this.rafEmitter, !0)), this._frameCallbacks.push(this._currentFrameID, t), (this._frameCallbackLength += 2))
                                : ((this._currentFrameID = this.rafEmitter.executor.subscribeImmediate(this.rafEmitter, !1)), this._currentFrameCallbacks.push(this._currentFrameID, t), (this._currentFrameCallbacksLength += 2))
                        ...
                        (this._cancelFrameIdx = this._nextFrameCallbacks.indexOf(t)),
                            this._cancelFrameIdx > -1
                                ...
                                : ((this._cancelFrameIdx = this._currentFrameCallbacks.indexOf(t)),
                                  this._cancelFrameIdx > -1 ? this._cancelCurrentAnimationFrame() : ((this._cancelFrameIdx = this._frameCallbacks.indexOf(t)), this._cancelFrameIdx > -1 && this._cancelRunningAnimationFrame()));
                    }),
        ...
        49: [
            function (t, e, i) {
                ...
                e.exports = function (t, e) {
                    ...
                    return e && /^[xy]$/i.test(e) ? r(t, e, s) : { x: r(t, "x", s), y: r(t, "y", s) };
                };
            },
            { 3: 3, 6: 6 },
        ],
            ...
            function (t, e, i) {
                ...
                e.exports = function (t, e, i, a) {
                    ...
                    if ((s.childNode(t, "ancestors"), s.selector(e, "ancestors"), i && n(t, r) && (!e || t.matches(e)) && o.push(t), t !== (a = a || document.body)))
                        for (; (t = t.parentNode) && n(t, r) && ((e && !t.matches(e)) || o.push(t), t !== a); );
                    return o;
                };
            },
            { 17: 17, 21: 21, 52: 52 },
        ...
        61: [
            function (t, e, i) {
                "use strict";
                var n = "undefined" != typeof window ? window.navigator : { userAgent: "", platform: "", vendor: "" },
                    s = { ua: n.userAgent, platform: n.platform, vendor: n.vendor };
                e.exports = t(60)(s);
            },
            { 60: 60 },
        ],
            ...
            function (t, e, i) {
                ...
                function f(t, e) {
                    n.call(this),
                        ...
                        (this._resizing = !1),
                        (this._mediaQueryLists = { resolution: { retina: window.matchMedia(h) }, orientation: { portrait: window.matchMedia(u), landscape: window.matchMedia(l) } }),
        ...
        63: [
            function (t, e, i) {
                ...
                var n = t(25),
                    ...
                    r = t(64),
                    a = function (t) {
                        new s(t, r).htmlClass(), n.call(this, t, { className: "ac-ln", selector: "#ac-localnav" });
        ...
        65: [
            function (t, e, i) {
                ...
                if (s) {
                    s.classList.add("ac-ln-sticking");
